            ...
            <thead class="bg-indigo-50 text-sm font-semibold text-gray-800 border-b border-indigo-200">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">Actions <a href="{{ route('students.create') }}"
                            class="ml-10 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Add New Student</a>
                    </th>
                    @endrole
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($students as $student)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 align-middle font-medium">{{ $student->first_name }}
                            {{ $student->last_name }}
                        </td>
